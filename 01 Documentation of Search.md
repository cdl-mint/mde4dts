...
73 Search Results by performing the following procedure on November 19th 2024 (available in file [/01 raw data/IEEE.csv](/01%20raw%20data/IEEE.csv)):
...
# ACM
64 Search Results by performing the following procedure on November 19th 2024 (available in file [/01 raw data/acm.csv](/01%20raw%20data/acm.csv)):
...
122 Search Results by performing the following procedure on November 19th 2024 (available in file [/01 raw data/WoS.xls](/01%20raw%20data/WoS.xls)): 
...
# Scopus
182 Search Results by performing the following procedure on November 19th 2024 (available in file [/01 raw data/scopus.csv](/01%20raw%20data/SCOPUS.csv)): 
