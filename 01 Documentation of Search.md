...
73 Search Results by performing the following procedure on April 3rd 2024 (available in file [/01 raw data/IEEE.csv](/01%20raw%20data/IEEE.csv)):
...
# ACM
50 Search Results by performing the following procedure on April 3rd 2024 (available in file [/01 raw data/acm.csv](/01%20raw%20data/acm.csv)):
...
122 Search Results by performing the following procedure on April 3rd 2024 (available in file [/01 raw data/WoS.xls](/01%20raw%20data/WoS.xls)): 
